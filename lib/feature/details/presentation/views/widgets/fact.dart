...
class Fact extends StatelessWidget {
  ...
  bool choosen = false;
   ...
   Fact({super.key, required this.dogType, required this.imagePath, required this.minLife, required this.maxLife, required this.goodWStrande});
          ...
          Row(
           ...
           Row(
            children: [
              ...
              Text("  goodness with Strangers: $goodWStrande ", style: Fonts.third),
            ],
          )
        ],
      ),
